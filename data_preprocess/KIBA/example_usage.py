"""
Example Usage of KIBA Pocket Graph Data
...
def main():
    ...
    print("="*60)
    print("KIBA Pocket Graph Data - Example Usage")
    print("="*60)
    
    # Example 1: Load and inspect a single graph
    print("\n[Example 1] Loading and inspecting graph data...")
    try:
        graph_dict = load_graph_data('KIBA_Domain_coord_graph_top1seqid_dict.pickle')
