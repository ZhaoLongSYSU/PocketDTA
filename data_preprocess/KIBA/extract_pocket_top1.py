"""
Pocket Extraction - Top 1 Prediction
...
Output:
    - KIBA_protein_domain_pocket_top1index_dict.pickle
    - KIBA_protein_domain_pocket_top1len_dict.pickle
    - KIBA_protein_domain_pocket_top1seq_dict.pickle
"""
...
with open('KIBA_protein_domain_pocket_top1index_dict.pickle', 'wb') as f:
    pickle.dump(proteins_pocket_index_dict, f)

with open('KIBA_protein_domain_pocket_top1len_dict.pickle', 'wb') as f:
    pickle.dump(proteins_pocket_indexlen_dict, f)

with open('KIBA_protein_domain_pocket_top1seq_dict.pickle', 'wb') as f:
