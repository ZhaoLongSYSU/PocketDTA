"""
Configuration Template for Davis Pocket Processing Pipeline
...
# Text file with protein IDs (one per line) for downloading
PROTEIN_ID_FILE = 'Davis_protein_id.txt'
...
PROTEIN_3D_DICT_FILE = 'Davis_Protein_Domain_Alphfold3d_dict.pickle'

# Pocket index dictionaries (output from extraction scripts)
POCKET_TOP1_INDEX_FILE = 'Davis_protein_domain_pocket_top1index_dict.pickle'
POCKET_TOP2_INDEX_FILE = 'Davis_protein_domain_pocket_top2index_dict.pickle'
POCKET_TOP3_INDEX_FILE = 'Davis_protein_domain_pocket_top3index_dict.pickle'

# Pocket length dictionaries
POCKET_TOP1_LEN_FILE = 'Davis_protein_domain_pocket_top1len_dict.pickle'
POCKET_TOP2_LEN_FILE = 'Davis_protein_domain_pocket_top2len_dict.pickle'
POCKET_TOP3_LEN_FILE = 'Davis_protein_domain_pocket_top3len_dict.pickle'

# Pocket sequence dictionaries
POCKET_TOP1_SEQ_FILE = 'Davis_protein_domain_pocket_top1seq_dict.pickle'
POCKET_TOP2_SEQ_FILE = 'Davis_protein_domain_pocket_top2seq_dict.pickle'
POCKET_TOP3_SEQ_FILE = 'Davis_protein_domain_pocket_top3seq_dict.pickle'

# Intermediate pocket coordinates dictionaries
POCKET_COORDS_TOP1_FILE = 'Davis_Domain_DoGsite3_top1seqid_dict.pickle'
POCKET_COORDS_TOP2_FILE = 'Davis_Domain_DoGsite3_top2seqid_dict.pickle'
POCKET_COORDS_TOP3_FILE = 'Davis_Domain_DoGsite3_top3seqid_dict.pickle'

# Final graph representation dictionaries
GRAPH_TOP1_FILE = 'Davis_Domain_coord_graph_top1seqid_dict.pickle'
GRAPH_TOP2_FILE = 'Davis_Domain_coord_graph_top2seqid_dict.pickle'
GRAPH_TOP3_FILE = 'Davis_Domain_coord_graph_top3seqid_dict.pickle'
