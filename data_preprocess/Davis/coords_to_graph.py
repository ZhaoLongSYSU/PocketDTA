"""
Protein Coordinates to Graph Conversion for Davis Dataset
...
Input:
    ...
    - Davis_protein_domain_pocket_top*index_dict.pickle
    - Davis_protein_domain_pocket_top*seq_dict.pickle

Output:
    - Davis_Domain_DoGsite3_top*seqid_dict.pickle (intermediate)
    - Davis_Domain_coord_graph_top*seqid_dict.pickle (final graph representation)
"""
...
def process_top_n(top_n, process_csv='process.csv', 
    ...
    with open(f'Davis_protein_domain_pocket_top{top_n}index_dict.pickle', 'rb') as f:
        pocket_dict = pickle.load(f)
    
    with open(f'Davis_protein_domain_pocket_top{top_n}seq_dict.pickle', 'rb') as f:
    ...
    with open(f'Davis_Domain_DoGsite3_top{top_n}seqid_dict.pickle', 'wb') as f:
    ...
    output_file = f'Davis_Domain_coord_graph_top{top_n}seqid_dict.pickle'
