"""
Pocket Extraction - Top 2 Predictions for Davis Dataset
...
Output:
    - Davis_protein_domain_pocket_top2index_dict.pickle
    - Davis_protein_domain_pocket_top2len_dict.pickle
    - Davis_protein_domain_pocket_top2seq_dict.pickle
"""
...
with open('Davis_protein_domain_pocket_top2index_dict.pickle', 'wb') as f:
    pickle.dump(proteins_pocket_index_dict, f)

with open('Davis_protein_domain_pocket_top2len_dict.pickle', 'wb') as f:
    pickle.dump(proteins_pocket_indexlen_dict, f)

with open('Davis_protein_domain_pocket_top2seq_dict.pickle', 'wb') as f:
...
print('\n# Davis dataset: max 64, min 15 (domain)')
