"""
Complete Davis Pocket Processing Pipeline
...
class PipelineRunner:
    """Manages the execution of the Davis pocket processing pipeline."""
    ...
    def run_all(self):
        ...
        print("\n" + "="*70)
        print("Davis Pocket Processing Pipeline")
        print("="*70)
        ...
        print("="*70)
        print("\nGenerated files:")
        print("  - Davis_Protein_Domain_Alphfold3d_dict.pickle")
        print("  - Davis_Domain_coord_graph_top1seqid_dict.pickle")
        print("  - Davis_Domain_coord_graph_top2seqid_dict.pickle")
        print("  - Davis_Domain_coord_graph_top3seqid_dict.pickle")
...
def main():
    parser = argparse.ArgumentParser(
        description='Run the Davis pocket processing pipeline'
    )
    parser.add_argument(
        '--step',
